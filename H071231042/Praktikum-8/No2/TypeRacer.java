...
public class TypeRacer {
    ...
    // 4 : Buat method addResult yang mana digunakan untuk menambahkan typer yang telah selesai (mengetik semua kata), ke dalam list race standing. 
    ...
    // 5 : Tampilkan klasemen akhir dari kompetisi, dengan format : {posisi}. {nama} = {waktu penyelesaian dalam detik} detik
        int position = 1;
    ...
    /* 7 : selama semua peserta belum selesai, maka tampilkan setiap 2 detik:
        * Typing Progress ...
        * ===================
    ...
    */
    ...
    // 8 : Tampilkan race standing setelah semua typer selesai. 
        printRaceStanding();
    }
}
